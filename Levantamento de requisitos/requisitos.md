# Desenvolvimento de Um Sistema de Gerenciamento de Estágio
---

O tema em estudo tem como objectivo criar um sistema que permitirá faciltar e centralizar as actividades de controle de estágios curriculares e extracurriculares de alunos de uma instituição de ensino.
...
RF02: O sistema deve possibilitar a recuperação de senha e edição de dados pessoais.
...
RF05: O sistema deve permitir que o aluno visualize e se candidate a vagas disponíveis.
RF06: O sistema deve permitir registar estágios em andamento, com informações como empresa,orientador, data de início e término.
RF07: O sistema deve permitir gerar e armazenar documentos oficias(termo de compromisso,plano de actividades, relatórios de acompanhamento).
...
RF10: Registar avaliações de desempenho do aluno(pela empresa e pelo orientador).
...
RF15: Possibilidade de filtrar e exportar dados(para Excel ou PDF).
RF16: Permitir backup e restauração dos dados do sistema.
...
RNF04: Apenas usuários autenticados podem acessar funções restritas.
